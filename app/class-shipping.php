...
class WC_Fetchr_Product_Shipping_Method extends WC_Shipping_Method{
    ...
    public function __construct(){
        ...
        $this->method_title = __( 'Fetchr  Shipping', 'woocommerce' );
...
//        }
    ...
    public function init_form_fields(){
        $this->form_fields = array(
            'fetchr_enabled' => array(
                'title'       => __( 'Enable/Disable', 'woocommerce' ),
                'type'            => 'checkbox',
                'label'       => __( 'Enable Fetchr Shipping for WooCommerce products', 'woocommerce' ),
                'default'         => 'yes'
            ),
            'fetchr_title' => array(
                'title'       => __( 'WooCommerce Fetchr Shipping', 'woocommerce' ),
                'type'            => 'text',
